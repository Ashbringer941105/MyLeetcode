...
//    public leetcode.TreeNode sortedArrayToBST(int[] nums) {
//        leetcode.TreeNode tn = null;
...
//     * @return
//     */
//    public leetcode.TreeNode getTree(int[] nums,int l,int r){
//        if(l<=r){
//            // 如果左起点小于右终点，则可以构造成树
//            int middle = (l+r)/2;
//            leetcode.TreeNode tn = new leetcode.TreeNode(nums[middle]);
